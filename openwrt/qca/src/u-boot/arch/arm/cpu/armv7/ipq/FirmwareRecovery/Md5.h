...
/*                    PUBLIC_FUNCTIONS                  */
/***************************************************************************/
extern void md5_make_digigned (unsigned char* digest, unsigned char* input, int len);
/*
 *\fn           check_Md5
 ...
 */
extern int check_Md5(unsigned char*md5, unsigned char *buf, unsigned int len);
/***************************************************************************/
/*                    GLOBAL_FUNCTIONS                  */
/***************************************************************************/
